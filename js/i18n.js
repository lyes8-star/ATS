...
(function () {
  ...
  const dict = {
    fr: {
      ...
      "results.checklist.fail.heading": "Contrôles ATS échoués",
      ...
      "studio.kicker": "Analyse sur votre CV",
      "studio.hint": "Les zones colorées pointent le passage exact. Cliquez pour voir pourquoi et la proposition.",
      ...
      "studio.checklist.recap": "contrôles ATS OK",
      ...
      "studio.pass.ok": "Passe les filtres",
      ...
      "studio.side.title": "Corrections sur votre CV",
      "studio.side.count": "{{total}} zone{{plural}} · {{accepted}} acceptée{{plural2}} · {{pending}} en attente",
      "studio.generate.button": "Export ATS 1 colonne",
      ...
      "studio.actions.downloadAts": "Export ATS linéaire",
    ...
    en: {
      ...
      "results.checklist.fail.heading": "Failed ATS checks",
      ...
      "studio.kicker": "Analysis on your CV",
      ...
      "studio.checklist.recap": "ATS checks OK",
      ...
      "studio.side.title": "Fixes on your CV",
      "studio.side.count": "{{total}} zone{{plural}} · {{accepted}} accepted · {{pending}} pending",
      "studio.generate.button": "Export linear ATS",
      ...
      "studio.actions.downloadAts": "Linear ATS export",
