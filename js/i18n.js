...
(function () {
  ...
  const dict = {
    fr: {
      ...
      "upload.jd.placeholder": "Collez l'annonce : active le matching CV↔offre et enrichit le prompt IA",
      "upload.pro.consent":
      ...
      "results.strengths.more": "{{n}} autres points solides",
      ...
      "studio.source.warnBody": "CV probablement créé avec {{tool}}. Risque pour les logiciels de recrutement et la crédibilité : reprenez en Word ou Google Docs, texte linéaire, sans bandeaux.",
      ...
      "studio.axis.readability": "Lecture automatique",
      "studio.axis.structure": "Structure",
      "studio.axis.content": "Contenu",
      "studio.axis.keywords": "Mots-clés",
      "studio.score.meaning": "Ce que signifie ce score",
      ...
      "studio.match.kicker": "Offre collée",
      "studio.match.title": "Correspondance CV ↔ offre",
      "studio.match.empty": "Collez une offre à l’upload pour activer la correspondance.",
      "studio.match.pending": "Offre détectée — correspondance en cours ou termes insuffisants.",
      "studio.match.score": "Alignement CV ↔ offre",
      "studio.match.mustCoverage": "Couverture des exigences",
      "studio.match.mustPresent": "Exigences présentes",
      "studio.match.mustMissing": "Exigences manquantes",
      "studio.match.niceTerms": "Atouts appréciés",
      "studio.match.overlap": "Termes communs",
      "studio.match.promptNote": "Ces exigences manquantes sont injectées dans le prompt IA ci-dessous.",
      "studio.match.explain": "Les exigences viennent de l’offre (compétences demandées). Les atouts sont un plus, pas bloquants.",
      "studio.match.proScore": "Score Pro ESCO : {{score}} %",
      "studio.aiPrompt.kicker": "Après l’analyse",
      "studio.aiPrompt.title": "Prompt IA — CV reconstruit",
      "studio.aiPrompt.lead": "Prompt prêt à coller : CV extrait + {{n}} correctif{{plural}} Test Mon CV.",
      "studio.aiPrompt.leadJd": "Prompt prêt à coller : adapte le CV à l’offre (correspondance) + {{n}} correctif{{plural}} Test Mon CV.",
      "studio.aiPrompt.copy": "Copier le prompt",
      "studio.aiPrompt.copied": "Prompt copié — collez-le dans ChatGPT, Claude ou Gemini.",
      "studio.aiPrompt.hint": "Collez le prompt dans une IA, puis copiez le CV Markdown généré dans Word ou Google Docs et exportez en PDF texte.",
    ...
    en: {
      ...
      "upload.jd.placeholder": "Paste the job posting: enables CV↔job matching and enriches the AI prompt",
      "upload.pro.consent":
      ...
      "studio.source.warnBody": "CV likely built with {{tool}}. Risk for recruiting software and credibility: rewrite in Word or Google Docs as linear plain text, no graphic banners.",
      ...
      "studio.axis.readability": "Automated reading",
      "studio.axis.structure": "Structure",
      "studio.axis.content": "Content",
      "studio.axis.keywords": "Keywords",
      "studio.score.meaning": "What this score means",
      ...
      "studio.match.kicker": "Job pasted",
      "studio.match.title": "CV ↔ job match",
      "studio.match.empty": "Paste a job posting at upload to enable matching.",
      "studio.match.pending": "Job detected — matching pending or not enough terms.",
      "studio.match.score": "CV ↔ job alignment",
      "studio.match.mustCoverage": "Requirement coverage",
      "studio.match.mustPresent": "Requirements present",
      "studio.match.mustMissing": "Missing requirements",
      "studio.match.niceTerms": "Nice-to-have strengths",
      "studio.match.overlap": "Shared terms",
      "studio.match.promptNote": "These missing requirements are injected into the AI prompt below.",
      "studio.match.explain": "Requirements come from the job posting (skills asked for). Nice-to-haves are a plus, not blockers.",
      "studio.match.proScore": "Pro ESCO score: {{score}}%",
      "studio.aiPrompt.kicker": "After analysis",
      "studio.aiPrompt.title": "AI prompt — rebuilt CV",
      "studio.aiPrompt.lead": "Ready-to-paste prompt: extracted CV + {{n}} Test Mon CV fix{{plural}}.",
      "studio.aiPrompt.leadJd": "Ready-to-paste prompt: tailor the CV to the job (alignment) + {{n}} Test Mon CV fix{{plural}}.",
      "studio.aiPrompt.copy": "Copy prompt",
      "studio.aiPrompt.copied": "Prompt copied — paste it into ChatGPT, Claude, or Gemini.",
      "studio.aiPrompt.hint": "Paste the prompt into an AI, then copy the Markdown CV into Word or Google Docs and export a text PDF.",
