...
(function () {
  ...
  const dict = {
    fr: {
      ...
      "studio.retest.ready": "Appliquez les corrections dans votre fichier, puis relancez un contrôle si besoin.",
    ...
    en: {
      ...
      "studio.retest.ready": "Apply the fixes in your file, then run another check if needed.",
