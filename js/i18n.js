...
(function () {
  ...
  const dict = {
    fr: {
      ...
      "home.cta.lead": "Sans compte. Fichier analysé localement. Corrections dans l’atelier.",
      ...
      "loading.step.3": "Préparation du diagnostic…",
      ...
      "results.open.studio": "Ouvrir l'atelier",
      "results.open.studio.withCount": "Ouvrir l'atelier ({{n}} suggestion{{plural}})",

      "studio.title": "Atelier de corrections",
      "studio.kicker": "Corrections sur votre document",
      "studio.hint": "Les zones colorées ciblent un passage. Cliquez pour voir le motif et la proposition.",
      "studio.score.initial": "Score initial",
      "studio.retest.pass": "Le document modifié se lit mieux automatiquement.",
      "studio.retest.continue": "Continuez les corrections pour viser 70+.",
      "studio.retest.continueButton": "Continuer les corrections",
      "studio.retest.ready": "Document prêt — téléchargez la version modifiée ou l’export linéaire.",
      ...
      "studio.side.count": "{{total}} zone{{plural}} · {{accepted}} acceptée{{plural2}} · {{pending}} en attente",
      "studio.generate.button": "Export linéaire 1 colonne",
      ...
      "studio.actions.download": "Télécharger le document modifié",
      "studio.actions.downloadWorking": "Télécharger le document modifié",
      "studio.actions.downloadAts": "Export linéaire",
    ...
    en: {
      ...
      "home.cta.lead": "No account. File analyzed locally. Fixes in the studio.",
      ...
      "loading.step.3": "Preparing the diagnostic…",
      ...
      "results.open.studio": "Open the studio",
      "results.open.studio.withCount": "Open the studio ({{n}} suggestion{{plural}})",

      "studio.title": "Correction studio",
      "studio.kicker": "Edits on your document",
      "studio.hint": "Colored zones mark the exact passage. Click to see why and the proposed fix.",
      "studio.score.initial": "Initial score",
      "studio.retest.pass": "The modified document reads better automatically.",
      "studio.retest.continue": "Keep fixing to aim for 70+.",
      "studio.retest.continueButton": "Continue edits",
      "studio.retest.ready": "Document ready — download the modified version or the linear export.",
      ...
      "studio.side.title": "Suggestions",
      "studio.side.count": "{{total}} zone{{plural}} · {{accepted}} accepted · {{pending}} pending",
      "studio.generate.button": "Linear 1-column export",
      ...
      "studio.actions.download": "Download modified document",
      "studio.actions.downloadWorking": "Download modified document",
      "studio.actions.downloadAts": "Linear export",
