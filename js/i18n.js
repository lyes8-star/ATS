...
(function () {
  ...
  const dict = {
    fr: {
      ...
      "studio.match.title": "Matching CV ↔ offre",
      "studio.match.empty": "Collez une offre à l’upload pour activer le matching.",
      "studio.match.pending": "Offre détectée — matching en cours ou termes insuffisants.",
      "studio.match.score": "Score global",
      "studio.match.mustCoverage": "Couverture must",
      "studio.match.mustPresent": "Must présents",
      "studio.match.mustMissing": "Must absents",
      "studio.match.niceTerms": "Nice to have",
      "studio.match.overlap": "Termes communs",
      "studio.match.promptNote": "Ces must absents sont injectés dans le prompt IA ci-dessous.",
      ...
      "studio.aiPrompt.leadJd": "Prompt prêt à coller : adapte le CV à l’offre (matching) + {{n}} correctif{{plural}} Test Mon CV.",
    ...
    en: {
      ...
      "studio.match.title": "CV ↔ job matching",
      ...
      "studio.match.score": "Overall score",
      "studio.match.mustCoverage": "Must-have coverage",
      "studio.match.mustPresent": "Must-haves present",
      "studio.match.mustMissing": "Must-haves missing",
      "studio.match.niceTerms": "Nice to have",
      "studio.match.overlap": "Shared terms",
      "studio.match.promptNote": "These missing must-haves are injected into the AI prompt below.",
      ...
      "studio.aiPrompt.leadJd": "Ready-to-paste prompt: tailor the CV to the job (matching) + {{n}} Test Mon CV fix{{plural}}.",
